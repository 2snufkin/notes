  ...
  return (
    <>
      ...
      <Routes>
        ...
        // nested routes: user/profile and user/account
...
As your React Router-powered application grows, you might find the need to restructure your project to keep things organized. For example, you can create a separate folder for all your pages and nest components related to specific routes within those folders. Always aim for modularity and maintainability.
